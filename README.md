...
- Open an in-app map with pinned locations for armor pieces and materials (coordinates shown for armor).
- Export and import JSON backups to move progress between browsers or devices.
